...
public class StatusBarSettings extends SettingsPreferenceFragment
    ...
    private void enableStatusBarBatteryDependents(int batteryIconStyle) {
        boolean disable = batteryIconStyle == STATUS_BAR_BATTERY_STYLE_TEXT
                || batteryIconStyle == STATUS_BAR_BATTERY_STYLE_IOS_15
                || batteryIconStyle == STATUS_BAR_BATTERY_STYLE_IOS_16;

        mStatusBarBatteryShowPercent.setEnabled(!disable);
    }
